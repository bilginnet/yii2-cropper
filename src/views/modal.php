        ...
        .'<div class="modal-content">'
            ...
            .'<div class="modal-footer">'
                ...
                .'<div class="pull-left">'
                    ...
                    .'</span>&nbsp;'
                    .'<div class="btn-group">'
                        .'<button type="button" class="btn btn-primary zoom-in"><span class="fa fa-search-plus"></span></button>'
                        .'<button type="button" class="btn btn-primary zoom-out"><span class="fa fa-search-minus"></span></button>'
                    .'</div>&nbsp;'
                    .'<div class="btn-group">'
                        .'<button type="button" class="btn btn-primary rotate-left"><span class="fa fa-rotate-left"></span></button>'
                        .'<button type="button" class="btn btn-primary rotate-right"><span class="fa fa-rotate-right"></span></button>'
                        .'<button type="button" class="btn btn-primary flip-horizontal"><span class="fa fa-arrows-h"></span></button>'
                        .'<button type="button" class="btn btn-primary flip-vertical"><span class="fa fa-arrows-v"></span></button>'
                    .'</div>&nbsp;'
                    .'<div class="btn-group">'
                        .'<button type="button" class="btn btn-primary move-left"><span class="fa fa-arrow-left"></span></button>'
                        .'<button type="button" class="btn btn-primary move-right"><span class="fa fa-arrow-right"></span></button>'
                        .'<button type="button" class="btn btn-primary move-up"><span class="fa fa-arrow-up"></span></button>'
                        .'<button type="button" class="btn btn-primary move-down"><span class="fa fa-arrow-down"></span></button>'
                    .'</div>'
                .'</div>'
